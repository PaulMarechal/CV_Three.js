...
//   const colorBackground = 0x21272D;
//   const densityBackground = 0.6;
//   scene.fog = new THREE.FogExp2(colorBackground, densityBackground);
...
scene.add( formationsPicture2 );
        ...
        // gui.add(directionalLight1.position, 'x').min(-20).max(20).step(0.01).name('Plane2 z')
        // gui.add(directionalLight1.position, 'y').min(-20).max(20).step(0.01).name('Plane8 y')
        // gui.add(directionalLight1.position, 'z').min(-20).max(20).step(0.01).name('Plane8 y')
        // gui.add(directionalLight1.rotation, 'y').min(-20).max(20).step(0.01).name('Plane8 y')
...
animationScripts.push({
    ...
    func: () => {
        camera.position.x = lerp(-0.2, 2.34, scalePercent(90, 100))
...
scene.add(ambientLight)
        ...
        // gui.add(directionalLight2.position, 'x').min(-20).max(20).step(0.01).name('Plane2 z')
        // gui.add(directionalLight2.position, 'y').min(-20).max(20).step(0.01).name('Plane8 y')
        // gui.add(directionalLight2.position, 'z').min(-20).max(20).step(0.01).name('Plane8 y')
        // gui.add(directionalLight2.rotation, 'y').min(-20).max(20).step(0.01).name('Plane8 y')
